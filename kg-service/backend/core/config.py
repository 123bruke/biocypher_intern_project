...
class Settings(BaseSettings):
    # Neo4j
    # Sync these with docker/neo4j.env (NEO4J_URI / NEO4J_USERNAME / NEO4J_PASSWORD).
    # The bolt port is the HOST-side port mapped by the compose file (default 7887).
    NEO4J_URI: str = "bolt://localhost:7887"
